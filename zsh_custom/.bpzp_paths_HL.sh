...
# Dropbox
notes_path=$dropbox_path/Main/Notes
db_tmp_path=$dropbox_path/tmp
journal_path=$dropbox_path/Main/PD_Important/Journal
...
# Misc
bitbar_path=~/Documents/BitBarPluggins
lec_281_path=~/Documents/@MAIN_DOCUMENTS/College/UM/Fall2017/EECS281NonRepo
